                    ...
                    <div class="trip-details">
                        ...
                        <div class="trip-gallery">
                            ...
                            <div class="gallery-slider">
                                @foreach($tour->tourimgscroll as $data)
                                <div class="single-slider"><img src="{{URL::to('backend/images/tour/'.$data->image)}}" alt="#"></div>
                                @endforeach
                            </div>
                        ...
                        <div class="trip-tab">
                            <div class="trip-tab-inner">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <?php $i = 0; ?>
                                    @foreach($tour->touritenerary as $ite)
                    ...
                    <div class="sidebar-main">
                        ...
                        <div class="single-widget trip-details">
                            ...
                            <div class="trip-list">
                                ...
                                <!-- single list -->
                                @foreach($trip->tourtripdetail as $tr)
                        ...
                        <div class="single-widget other-trips">
                            ...
                            <div class="trips">
                                ...
                                <div class="signle-trip">
                                    <img src="{{URL::to('backend/images/tour/'.$data->image)}}" alt="#">
                                    <div class="text">
