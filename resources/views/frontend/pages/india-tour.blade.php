                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-package">
                            <div class="trip-head">
                                ...
                                @endif
                                <img src="{{URL::to('backend/images/india_tour/'.$data->image)}}" alt="#" style="height:195px;">
                            </div>
                            <div class="trip-details">
                                ...
                                <a href="{{route('indiatour_details',['slug'=>$data->slug])}}" class="btn primary">View Details</a>
                            </div>
                        </div>
                        <!--/ End Single Package -->
                    </div>
