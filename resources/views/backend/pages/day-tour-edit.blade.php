                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <a href="{{route('day_tour')}}" class="btn btn-sm btn-primary btn-create"><i class="fa fa-reply"></i>Back</a>
                            ...
                            <div class="panel-body">
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#edit" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Edit Tour</a>
                                        </li>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade active in" id="edit" aria-labelledby="home-tab">
                                            <form class="form-horizontal form-label-left" method="post" id="tour_form"
                                                  action="{{route('daytouredit_action',['id'=>$datas->id])}}" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                ...
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <div>
                                                        <input type="text" name="package"  value="{{$datas->package}}"  class="form-control">
                                                    </div>
                                                </div>
                                            ...
                                            @foreach($datas->daytripdetail as $data)
                                                <div class="col-md-12 col-sm-12 col-xs-12">

                                                    <form method="post" action="{{route('daytripedit_action',['id'=>$data->id])}}">
                                                        {{csrf_field()}}
                                                        <div class="form-group col-lg-12">
                                            ...
                                            @foreach($datas->daytouritenerary as $data)
                                                <div class="col-md-6 col-sm-6 col-xs-6">

                                                    <form method="post" action="{{route('daytouriteedit_action',['id'=>$data->id])}}">
                                                        {{csrf_field()}}
                                                    ...
                                                    <span style="float: left;">
                                                     <form method="post" action="{{route('daytouritenerary_del',['id'=>$data->id])}}">
                                                         {{csrf_field()}}
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="slider" aria-labelledby="profile-tab">
                                            @foreach($datas->daytourscrollimg as $da)
                                                <div class="col-md-3 col-sm-3 col-xs-3">


                                                        <form method="post" action="{{route('daytourscroll_del',['id'=>$da->id])}}">
                                                            {{csrf_field()}}
                                                            <button type="submit" class="btn btn-danger" title="delete"><i class="fa fa-trash m-right-xs"></i></button>
                                                            <br><img src="{{URL::to('backend/images/daytour/'.$da->image)}}" style="height:80px;width:120px;" alt="image">
                                                        </form>
                                                    <br>
                                                        <form method="post" action="{{route('daytourset',['id'=>$da->DayTour_id,'img'=>$da->image])}}">
                                                            {{csrf_field()}}
                                                            <span style="float: left">
