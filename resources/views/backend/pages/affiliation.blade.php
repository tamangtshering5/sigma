                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        @if(count($errors)>0)
                            ...
                            @endforeach
                        @endif
                        <h2><i class="fa fa-tag"></i> Affiliated With </h2>
                    ...
                    <div class="x_content">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#ticketing" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Edit Affiliation</a>
                                </li>
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="ticketing" aria-labelledby="home-tab">
                                    @foreach($datas as $data)
                                        <form class="form-horizontal form-label-left" method="post" action="{{route('affiliation_action',['id'=>$data->id])}}" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <div class="jumbotron jumbotron-fluid">
                                                    <div class="container">
                                                        <img src="{{URL::to('backend/images/affiliation/'.$data->image)}}" style="height:160px;width:100%;">
                                                    </div>
                                                </div>
                                            </div>
