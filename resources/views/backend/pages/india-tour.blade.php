                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-6">
                                        <h3 class="panel-title">India Tour</h3>
                                    </div>
                                        ...
                                        <div class="card-container">
                                            <div class="card">
                                                <div class="card-image">
                                                    <img src="{{URL::to('backend/images/india_tour/'.$data->image)}}" alt="" style="height:275px;width:100%;"/>
                                                </div>
                                                <div class="card-info">
                                                ...
                                                <div class="card-social">
                                                    <ul>
                                                        <li><a href="{{route('india_edit',['id'=>$data->id])}}"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
                                                        </li>

                                                        <form method="post" action="{{route('india_del',['id'=>$data->id])}}">
                                                            <li>
                                                                {{csrf_field()}}
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal form-label-left" method="post" id="tour_form"
                                              action="{{route('india_action')}}" enctype="multipart/form-data">
                                            {{csrf_field()}}
