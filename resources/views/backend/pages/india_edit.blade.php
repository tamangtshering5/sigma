                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <a href="{{route('india_tour')}}" class="btn btn-sm btn-primary btn-create"><i class="fa fa-reply"></i>Back</a>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade active in" id="edit" aria-labelledby="home-tab">
                                            <form class="form-horizontal form-label-left" method="post" id="tour_form"
                                                  action="{{route('indiaedit_action',['id'=>$datas->id])}}" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                            ...
                                            @foreach($datas->indiatripdetail as $data)
                                                <div class="col-md-12 col-sm-12 col-xs-12">

                                                    <form method="post" action="{{route('indiatripedit_action',['id'=>$data->id])}}">
                                                        {{csrf_field()}}
                                                        <div class="form-group col-lg-12">
                                            ...
                                            @foreach($datas->indiaitenerary as $data)
                                                <div class="col-md-6 col-sm-6 col-xs-6">

                                                    <form method="post" action="{{route('indiaiteedit_action',['id'=>$data->id])}}">
                                                        {{csrf_field()}}
                                                    ...
                                                    <span style="float: right; margin-top:-50px;">
                                                     <form method="post" action="{{route('indiaitenerary_del',['id'=>$data->id])}}">
                                                         {{csrf_field()}}
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="slider" aria-labelledby="profile-tab">
                                            @foreach($datas->indiascrollimg as $da)
                                                <div class="col-md-3 col-sm-3 col-xs-3">


                                                    <form method="post" action="{{route('indiascroll_del',['id'=>$da->id])}}">
                                                        {{csrf_field()}}
                                                        <button type="submit" class="btn btn-danger" title="delete"><i class="fa fa-trash m-right-xs"></i></button>
                                                        <br><img src="{{URL::to('backend/images/india_tour/'.$da->image)}}" style="height:80px;width:120px;" alt="image">
                                                    </form>
                                                    <br>
                                                    <form method="post" action="{{route('indiaset',['id'=>$da->IndiaTour_id,'img'=>$da->image])}}">
                                                        {{csrf_field()}}
                                                        <span style="float: left">
