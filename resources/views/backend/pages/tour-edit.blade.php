                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col col-xs-6 text-right">
                                    <a href="{{route('tour')}}" class="btn btn-sm btn-primary btn-create"><i class="fa fa-reply"></i>Back</a>
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="edit" aria-labelledby="home-tab">
                                    ...
                                    @foreach($datas->tourtripdetail as $data)
                                        <div class="col-md-12 col-sm-12 col-xs-12">

                                            <form method="post" action="{{route('tourtripedit_action',['id'=>$data->id])}}">
                                                {{csrf_field()}}
                                                <div class="form-group col-lg-12">
...
{{--/////////////////itenerary edit/////////////////////////////////--}}
                                    ...
                                    <h2 style="margin-top:30px;"><i class="fa fa-tag"></i>&nbsp;Itenerary</h2>
                                     @foreach($datas->touritenerary as $data)
                                         <div class="col-md-6 col-sm-6 col-xs-6">

                                                 <form method="post" action="{{route('touriteedit_action',['id'=>$data->id])}}">
                                                     {{csrf_field()}}
                                             ...
                                             <span style="float: right; margin-top:-50px;">
                                                     <form method="post" action="{{route('touritenerary_del',['id'=>$data->id])}}">
                                                         {{csrf_field()}}
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="slider" aria-labelledby="profile-tab">
                                    @foreach($datas->tourimgscroll as $da)
                                        <div class="col-md-3 col-sm-3 col-xs-3">


                                                <form method="post" action="{{route('tourscroll_del',['id'=>$da->id])}}">
                                                    {{csrf_field()}}
                                                    <button type="submit" class="btn btn-danger" title="delete"><i class="fa fa-trash m-right-xs"></i></button>
                                                    <br><img src="{{URL::to('backend/images/tour/'.$da->image)}}" style="height:80px;width:120px;" alt="image">
                                                </form>
                                            <br>
                                            <form method="post" action="{{route('tourset',['id'=>$da->Tour_id,'img'=>$da->image])}}">
                                                {{csrf_field()}}
                                                <span style="float: left">
