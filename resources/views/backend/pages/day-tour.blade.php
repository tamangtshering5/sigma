                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-6">
                                        <h3 class="panel-title">One Day Tours</h3>
                                    </div>
                                        ...
                                        <div class="card-container">
                                            <div class="card">
                                                <div class="card-image">
                                                    <img src="{{URL::to('backend/images/daytour/'.$data->image)}}" alt="" style="height:275px;width:100%;"/>
                                                </div>
                                                <div class="card-info">
                                                ...
                                                <div class="card-social">
                                                    <ul>
                                                        <li><a href="{{route('daytour_edit',['id'=>$data->id])}}"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
                                                        </li>

                                                        <form method="post" action="{{route('daytour_del',['id'=>$data->id])}}">
                                                            <li>
                                                                {{csrf_field()}}
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal form-label-left" method="post" id="tour_form"
                                              action="{{route('daytour_action')}}" enctype="multipart/form-data">
                                            {{csrf_field()}}
